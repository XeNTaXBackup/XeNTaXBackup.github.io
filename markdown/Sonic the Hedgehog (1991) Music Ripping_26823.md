...
- Post datetime: 2023-06-05T16:55:14+00:00
- Post Title: Sonic the Hedgehog (1991) Music Ripping

Can someone help me with the ways I can rip music from Sonic 1 on the Sega Genesis?
One of the samples' coding is listed, but you should use a music extractor by the filename of ".ASM", so I can get the samples ripped finally afterwards.

Music ID/Sound Test ID: 81 (Green Hill Zone)
...
Code is from s1disasm-AS REV02\s1disasm-AS\sound\music\Mus81 - GHZ.asm.

Also, if anyone could help me using the programs I haven't used to rip the music from before.
